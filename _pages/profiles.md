...
<div class="people-page">
  <section class="people-intro">
    <p>
      We are a multidisciplinary group spanning computer architecture, machine learning systems, and high-performance computing.
      Our team includes PhD researchers, graduate collaborators, and undergraduate contributors.
    </p>
  </section>
    ...
    <article class="people-professor-card">
      ...
      <div>
        ...
        <div class="people-badge-row">
          ...
          <span class="people-badge">HPC</span>
        </div>
      </div>
    </article>
  </section>
  ...
  <section class="people-group">
    ...
    <div class="people-grid">
      ...
      <!-- <article class="people-card">
        ...
        <p>Benchmarking and diagnostics</p>
      </article>
      <article class="people-card">
        <img src="{{ '/assets/img/10.jpg' | relative_url }}" alt="Graduate student portrait" />
